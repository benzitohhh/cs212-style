...
inventory:
	...
	states  		atomic # alogrithm doesn't need to know about precise representation...
	actions 		actomic # alogrithm doesn't need to know about representations...
	succesors 		# some function: state -> {state:action, state:action...}
	start			atomic # alogrithm doesn't need to know about precise representation...
	goal      		# some isGoal() function: state -> boolean


so our function just looks like this:

	shortest_path_search(start, goal, successors)
