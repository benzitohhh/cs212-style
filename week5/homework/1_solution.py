...
#
# Take care when value of pending is 0 (special case)
#
...
# Notice how Professor Norvig's solution
# calculates utility in one function
# (i.e. without seperate U / Q / getActions / bestAction functions..)
...
def Pwin3(me, you, pending):
    if me + pending >= goal:
       return 1 # terminal state
        ...
        # We can't calculate HOLD prob here, as could enter infinite loop
        #         - i.e. at each turn player holds with 0 points, score will stay 0 forever!

        # if not pending, then only possible action is roll - so return Proll
        # Otherwise, return maximum of Proll, Phold
