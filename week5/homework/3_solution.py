...
# Once again, notice how Professor Norvig's solution
# does not work out the optimal strategy (i.e. U, Q, getActions, bestAction etc...)
# Instead, he goes for a very simple, elegant solution
